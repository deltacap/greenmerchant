...
`,Aa=Kt.section`
  ...
  background-image: 
    ...
    url(${"/greenmerchant"}/assets/images/business-funding.jpg);
  background-size: cover;
  background-position: center;
  background-attachment: fixed;
  position: relative;
